...
class ProjetAdmin(admin.ModelAdmin):
    list_display = ('id', 'utilisateur', 'resume', 'lien')
...
class ExperienceAdmin(admin.ModelAdmin):
    list_display = ('id', 'utilisateur', 'role', 'nom_entreprise', 'date_debut', 'date_fin')
    list_filter = ('utilisateur',)
...
class ServiceAdmin(admin.ModelAdmin):
    list_display = ('id', 'utilisateur', 'type_de_service', 'details')
    list_filter = ('utilisateur',)
